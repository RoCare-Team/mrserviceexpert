...
//  const [phoneNumber, setPhoneNumber] = useState('');
  ...
  const handleSubmit = async(event) => {
    ...
    const res = await fetch("https://waterpurifierservicecenter.in/customer/ro_customer/add_address.php", {
      ...
      // body: JSON.stringify(formData.houseNo, formData.street, formData.landmark, formData.city, formData.state, formData.pincode,formData.email,formData.alterphone,formData.phone,formData.phoneNumber),
  });
  ...
  localStorage.setItem('RecentAddress', JSON.stringify(data));
  localStorage.setItem('address_id',data.address_id);
  // console.log(data.address_id);
  
// const chetak=JSON.parse(localStorage.getItem('bookingAddres'));
//   console.log(chetak);
