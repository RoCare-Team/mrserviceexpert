...
const ServicePage = () => {
    ...
    useEffect(()=>{
       const cartDataString=localStorage.getItem('checkoutState');
       if(cartDataString){
            ...
            <div className="right-side lg:w-3/4">
                <div className="rightSidePortion justify-center">
                    <div className="lg:w-1/2">
                        <h2 className="ml-2.5 mt-1.5 text-3xl">{formattedBrands} Services in {formattedState}</h2>
